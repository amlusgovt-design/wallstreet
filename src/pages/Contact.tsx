        ...
        <div>
          <div className="text-lg mb-8">
            ...
            <p className="max-w-72 text-lg mb-10">
              Email or Call to learn how Wallstreets Global Trading Academy can
              help you invest
            </p>
            <div className="flex items-center mb-3  gap-x-3">
              <MdEmail />
              <p>info@wallstreetsglobaltradingacademy.com</p>
            </div>
          ...
          <div className="mb-10 xl:mb-0 xl:flex xl:gap-x-10 ">
            ...
            <div>
              ...
              <p className="max-w-[400px] text-lg">
                ...
                Wallstreets Global Trading Academy. Your input is crucial in
                shaping the future of Wallstreets Global Trading Academy.
              </p>
            </div>
          </div>
        </div>
