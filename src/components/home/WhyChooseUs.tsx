      ...
      <div className="max-w-[1240px] mx-auto">
        <div className="text-center">
          <h2 className="text-3xl font-semibold lg:text-5xl lg:font-extrabold mb-10">
            Why Wallstreets Global Trading Academy?
          </h2>
          <p className="lg:max-w-[70%] mx-auto leading-7 mb-24 text-xl">
            At Wallstreets Global Trading Academy, we seamlessly blend the
            expertise of seasoned human discretionary traders with strategic
            hedge execution decisions influenced by client trading behavior and
            account performance. With over 600 products in our portfolio, we
            offer narrow spreads, transparent pricing, and robust platforms.
            Backed by outstanding customer service, our commitment is to deliver
            an unparalleled trading journey for our clients.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-3 xl:grid-cols-4 xl:gap-8">
          ...
          <WCUCard
            ...
            description="Wallstreets Global Trading Academy operates in full compliance with SEC and CFTC, ensuring a secure environment for your investments"
          />
          <WCUCard
            img={<FaHeadset />}
            text="24/7 Support"
            description="Wallstreets Global Trading Academy abides by all regulations set forth by the SEC and CFTC, guaranteeing a secure environment for your investments."
          />
          <WCUCard
            img={<FaUser />}
